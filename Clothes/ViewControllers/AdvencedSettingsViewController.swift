...
class AdvencedSettingsViewController: UIViewController {
    ...
    if (typeMultigrib) { sendDataToHC10(dataForWrite: data, characteristic:                                         sampleGattAttributes.FESTO_A_CHARACTERISTIC, myCase: String(0))
            print("shutdownCurrentSlideStop   typeMultigrib")
        }
        else {
    ...
    private func initUI() {
        ...
        for item in savingParametrsMassString
        {
            ...
            if (item.key == SensorsViewController.sampleGattAttributes.SCALE) {
                ...
                case 0:
                    scaleText.text = "prosthesis size: S"
                case 1:
                    scaleText.text = "prosthesis size: M"
                case 2:
                    scaleText.text = "prosthesis size: L"
                case 3:
                    scaleText.text = "prosthesis size: XL"
                default:
                    scaleText.text = "prosthesis size: S"
                }
            }
