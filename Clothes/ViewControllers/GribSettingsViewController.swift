//
//  GribSettingsViewController.swift
//  MotoricaStart
//
//  Created by Motorica LLC on 30.06.2021.
//  Copyright © 2021 Brian Advent. All rights reserved.
//

import UIKit

class GribSettingsViewController: UIViewController {
    @IBOutlet var containerView: UIView!
    @IBOutlet weak var deviceName: UILabel!
    @IBOutlet weak var numberGesture: UILabel!
    @IBOutlet weak var statusImage: UIImageView!
    @IBOutlet weak var saveBtn: UIButton!
    @IBOutlet weak var openLittleFinger: UISwitch!
    @IBOutlet weak var openRingFinger: UISwitch!
    @IBOutlet weak var openMiddleFinger: UISwitch!
    @IBOutlet weak var openForefinger: UISwitch!
    @IBOutlet weak var openThumb: UISwitch!
    @IBOutlet weak var openThumbRotation: UISwitch!
    @IBOutlet weak var closeLittleFinger: UISwitch!
    @IBOutlet weak var closeRingFinger: UISwitch!
    @IBOutlet weak var closeMiddleFinger: UISwitch!
    @IBOutlet weak var closeForefinger: UISwitch!
    @IBOutlet weak var closeThumb: UISwitch!
    @IBOutlet weak var closeThumbRotation: UISwitch!
